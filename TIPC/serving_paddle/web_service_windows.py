...
class InfoXLMOp(Op):
    ...
    def init_op(self):
        ...
        self.tokenizer = InfoXLMTokenizer.from_pretrained(
            "C:/Users/kinet/OneDrive/Speech Recognition/infoxlm_paddle/model_checkpoints/finetuned_paddle"
        )
    ...
    def preprocess(self, input_dicts, data_id, log_id):
        ...
        data = self.tokenizer(all_text_a, all_text_b,)
        input_ids = self.batchify_fn(data["input_ids"])
        return {"input_ids": input_ids,}, False, None, ""
